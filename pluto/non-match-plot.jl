...
# ╔═╡ 71c6d706-fe91-4505-89ff-806fb2be7da5
using Plots

# ╔═╡ 8a640910-b29f-4392-8e6d-abf47dd6242f
using JSON

# ╔═╡ f9ec5a2f-7b45-4bbb-a849-b38e3c471ab3
using Statistics

# ╔═╡ 9f4d0540-fa10-47b3-8117-255e85be0ed6
using LaTeXStrings

# ╔═╡ 32783d16-1083-11ef-2e0f-1330a5d95f96
md"""
# Plot of non-matches

Plot number of non-matching numbers for sequences using cached JSON data
"""
...
# ╔═╡ b9fbeb2f-3c98-4b08-95f2-ff9f63f89369
begin
	base = nm_res["base"]
	seq_len = nm_res["seq_len"]
	power = nm_res["power"]
	start = nm_res["start"]
	stop = nm_res["stop"]
	results = nm_res["results"]
end

# ╔═╡ c2cb3984-2bee-4195-8326-8891098ac0c4
md"Rebuild string sequences"

# ╔═╡ 65976913-43f4-4963-85de-c17d2ccb563c
seq_matches = [Base.GMP.string(BigInt(i - 1), base = base, pad = seq_len)
                   for i in 1:base^seq_len]

# ╔═╡ 87190ee7-1489-4783-956a-e405e895d772
begin
...
# ╔═╡ bfb5c284-7535-49b6-8fa0-76b7caa48988
begin
	xlabel = "Sequence of $(seq_len) digits"
	if power == 0
		ylabel = "Random non-matches - mean ($na_avg)"
		title = """Random non-matches for $(nm_res["length"]) digits,\n$stop samples, base $base"""
	else
...
begin
	...
	savefig(plt, joinpath("..", "results",
        "non-apocalyptic-matches-v4-base-$(base)-power-$(power)-seq-$(seq_len).png"))
	plt
end
...
manifest_format = "2.0"
project_hash = "46dd00761c09cbe0b0aa5fe7fb31943171ef6ba4"
