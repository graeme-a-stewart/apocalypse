...
# ╔═╡ 0f04779c-2efb-4b86-8ae2-bb83edaa559a
using Random

# ╔═╡ 732fbe3d-cde9-4dad-8133-73bebde03ebc
using Plots

# ╔═╡ f9529076-0b18-11ef-22ed-af508dc62468
md"""# Product Sequences

Instead of powers of $p^n$, study matches against numbers that are formed
from random products. e.g., $N*M$, where $N$ and $M$ are random.

This should study if there is a digit bias introduced by the act of multiplication.
"""

# ╔═╡ fc701840-361f-4058-b162-b380655e02a9
rng = MersenneTwister(123)

# ╔═╡ c15d2c95-571f-4057-a3ca-cd0ea550bdf0
n_min = big"1"

# ╔═╡ 27105afd-5ac6-4746-b939-a883ea718c83
n_max = big"10"^100

# ╔═╡ 0b47bd48-a2eb-4569-a5bf-5ba3eb2405d6
N = rand(rng, n_min:n_max)

# ╔═╡ b11ddaae-0a25-4cb5-985e-75fcee547fea
M = rand(rng, n_min:n_max)

# ╔═╡ 4fd14c69-e943-45d4-8ab6-3fa37aef4d11
P=N*M

# ╔═╡ 89910be2-5998-4b73-af13-1a5d155fd543
P_str = Base.GMP.string(P)

# ╔═╡ 5e92ee6f-881c-4679-b68c-798046b68f2e
